...
const questions = [
    {
        question: "L'Homme était d'abbord sédentaire, puis nomade.",
        options: ["Vrai", "Faux", "Ca dépend"],
        correctAnswer: "Faux"
    },
    {
        question: "Quelle est l'ère qui suit le Paléolithique?",
        options: ["L'Antiquité", "Le Néolithique", "L'Âge de Métaux"],
        correctAnswer: "Le Néolithique"
    },
    {
        question: "L'Homme est apparut sous différentes formes.",
        options: ["Vrai", "Faux"],
        correctAnswer:  "Vrai"
    }
